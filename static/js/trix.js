...
!(function (t, e) {
  ...
  const h = "\ufeff",
    ...
    b = function (t) {
      ...
      return (
        s.initEvent(t, i, n), null != r && g.call(s, r), o.dispatchEvent(s)
      );
    },
    v = function (t, e) {
  ...
  class re extends ee {
    ...
    createCaptionElement() {
      const t = k({ tagName: "figcaption", className: ne.attachmentCaption }),
  ...
  class ae extends re {
    ...
    createCaptionElement() {
      ...
      return (
        t.textContent ||
          t.setAttribute("data-trix-placeholder", l.captionPlaceholder),
        t
      );
    }
    refresh(t) {
  ...
  class le extends ee {
    ...
    createElement() {
      ...
      if (Object.keys(n).length)
        for (e in (t || (t = k("span")), n)) (i = n[e]), (t.style[e] = i);
      return t;
    }
    createContainerElement() {
  ...
  class de extends ee {
    ...
    createNodes() {
      ...
      if (this.block.isEmpty()) t.push(k("br"));
        ...
        var e;
        const i =
            null === (e = gt(this.block.getLastAttribute())) || void 0 === e
              ? void 0
              : e.text,
  ...
  class ke extends nt {
    ...
    splitObjectsAtRange(t) {
      ...
      return (
        ([i, e] = new this.constructor(i).splitObjectAtPosition(we(t) + r)),
        [i, n, e - 1]
      );
    }
  ...
  const Fe = function (t) {
    ...
    Ie = function (t) {
      ...
      return r
        ? ((n = n.map((t) => (t.isBlockBreak() ? ((e = !0), Me(t)) : t))),
          e ? new Te([...n, r]) : t)
        : t;
    },
      ...
      if (Dt(t)) return this.getCommonAttributesAtPosition(e);
      {
        ...
        return (
          this.eachBlockAtRange(t, function (t, n) {
            if (n[0] !== n[1])
              return (
                e.push(t.text.getCommonAttributesAtRange(n)), i.push(Ve(t))
              );
          }),
          _t
  ...
  class Xe extends z {
    ...
    isBlockElement(t) {
      if (
        ...
        !P(t) &&
        !A(t, { matchingSelector: "td", untilNode: this.containerElement })
      )
        return (
          D().includes(E(t)) || "block" === window.getComputedStyle(t).display
        );
    }
  ...
  class bi {
    ...
    removeBlockAttribute() {
      return this.findRangesOfBlocks().map(
        (t) => (this.document = this.document.removeAttributeAtRange(fi, t))
      );
    }
    applyBlockAttribute() {
      let t = 0;
  ...
  class xi {
    ...
    loadHTML() {
      let t =
        arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "";
      const e = Xe.parse(t, { referenceElement: this.element }).getDocument();
      ...
      if (n) {
        if (O(n))
          ...
          if (((e = n.parentNode), !T(n.previousSibling) && !w(e)))
            for (; n === e.lastChild && ((n = e), (e = e.parentNode), !w(e)); );
          (i = C(n)), 0 !== t.offset && i++;
        }
        return [e, i];
      }
  ...
  class Li extends z {
    ...
    domRangeWithinElement(t) {
      return t.collapsed
        ...
        : y(this.element, t.startContainer) && y(this.element, t.endContainer);
    }
  }
  ...
  class Pi extends z {
    constructor(t, e, i) {
      ...
      super(...arguments),
        ...
        Ae(
          ...
          Ii(() => {
            ...
            return (
              ...
              f("click", { onElement: t, withCallback: this.didClickToolbar }),
              f("click", {
                onElement: t,
        ...
        Ae(
          ...
          Ii(() => {
            ...
            f("input", { onElement: t, withCallback: i }),
              f("input", { onElement: t, withCallback: this.didInputCaption }),
              f("keydown", {
                onElement: t,
              ...
              f("blur", { onElement: t, withCallback: this.didBlurCaption });
            ...
            return {
              do: () => {
                if (
                  ...
                  r.appendChild(t),
                  r.appendChild(e),
                  r.classList.add("".concat(Bi.attachmentCaption, "--editing")),
        ...
        "a" === E(this.element) && (this.element = this.element.firstChild),
        this.install();
    }
    install() {
  ...
  class Ni extends z {
    constructor(t, i) {
      super(...arguments),
        ...
        f("focus", { onElement: this.element, withCallback: this.didFocus }),
        f("blur", { onElement: this.element, withCallback: this.didBlur }),
        f("click", {
          onElement: this.element,
  ...
  class zi {
    ...
    insertingLongTextAfterUnidentifiedChar() {
      ...
      return (
        ...
        (null === (t = this.event.data) || void 0 === t ? void 0 : t.length) >
          50
      );
    }
  ...
  class Ki extends z {
    constructor(t) {
      ...
      for (const t in this.constructor.events)
        f(t, { onElement: this.element, withCallback: this.handlerFor(t) });
    }
    elementDidMutate(t) {}
    ...
    paste(t) {
      ...
      if (n) {
        ...
        if (t) {
          var b, v, A;
          const e = Zi(t);
          !t.name && e && (t.name = "pasted-file-".concat(++Yi, ".").concat(e)),
            (i.type = "File"),
            (i.file = t),
  ...
  class Rn extends Oi {
    constructor(t) {
      ...
      super(...arguments),
        ...
        (this.attachmentManager = new hi(this.composition.getAttachments())),
        ...
        (this.toolbarController = new Cn(this.editorElement.toolbarElement)),
